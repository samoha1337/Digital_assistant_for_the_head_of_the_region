...
class NLULongPollBot(LongPollBot):
    ...
    def __init__(self):
        ...
        with open("bot_corpus/key_words.json", encoding="utf-8") as file:
    ...
    def get_intent(self, request: str):
        ...
        """
        question_probabilities = self.classifier.predict_proba(self.vectorizer.transform([request]))[0]##################################################################################################[0]
    ...
    def create_bot_dialog_dataset(self):
        ...
        if not os.path.isfile("bot_corpus/answer_examples_for_learning.txt"):
        ...
        with open("bot_corpus/answer_examples_for_learning.txt", encoding="utf-8") as file:
            content = file.read()
